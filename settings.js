...
const BOTNAME = 'PASAN-MD|-WA-BOT™';
const FOOTERNAME = '> P A S A N -  ＭＤ - BOT';
global.owner = process.env.OWNER_NUMBER  || '94767813339' ;  // ADD YOUR NUMBER WITHOUT +
...
OWNER_NAME: process.env.OWNER_NAME || 'PASAN' ,
COMMAND_TYPE: process.env.COMMAND_TYPE || 'button' ,
LOGO: process.env.LOGO || `https://telegra.ph/file/15c6e7de4296016f1edb3.jpg` ,
POSTGRESQL_URL: process.env.POSTGRESQL_URL === undefined ? 'postgres://vajiratech_user:oSIFl2xmSojMZ0rkzdd0g0W6msuVTpNN@dpg-cpd7fjv109ks73e5gtig-a.frankfurt-postgres.render.com/vajiratech' : process.env.POSTGRESQL_URL,
FOOTER: process.env.FOOTER || '‌👩‍💻 PASAN -  ＭＤ - BOT👩‍💻',    
